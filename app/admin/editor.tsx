// Client-side markdown editor with live preview and cache invalidation controls.
// Receives pre-fetched doc lists from the cached server shell — no waterfall fetch.
"use client";
...
export function AdminEditor({
  ...
  allDocs: Record<string, DocEntry[]>;
}) {
